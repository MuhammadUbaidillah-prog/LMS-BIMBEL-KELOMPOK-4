...
export default function AdminDashboardPage() {
  ...
  // Menyisakan opsi tab untuk payments dan academic saja, default langsung ke payments
  const [activeTab, setActiveTab] = useState<"payments" | "academic">("payments");
  const [user, setUser] = useState<User | null>(null);

  // States mirroring core collections khusus porsi kerja Admin
  ...
  return (
    <div className="space-y-6 text-slate-800 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white border border-slate-100 rounded-2xl p-6 shadow-sm">
        ...
        {/* Menyisakan tab subnavigasi eksklusif milik Admin */}
