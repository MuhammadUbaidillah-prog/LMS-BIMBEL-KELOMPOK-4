...
export default function SuperAdminLayout({
  ...
  useEffect(() => {
    ...
    // MENYESUAIKAN ROLE: Membaca string "superadmin" tanpa underscore sesuai dummy-data.ts
    ...
    <div className="dashboard-layout">
      ...
      <aside className={`sidebar ${sidebarOpen ? "sidebar-mobile-open" : ""}`}>
        ...
        <div className="sidebar-logout">
          <button id="nav-super-admin-logout" className="sidebar-nav-item logout-item" onClick={handleLogout}>
          ...
          <div className="topbar-user flex items-center gap-3">
            <div className="flex items-center gap-3 pl-4 cursor-pointer group">
              ...
              <div className="hidden sm:flex flex-col text-left leading-none">
                ...
                <span className="text-[10px] text-slate-400 mt-0.5">Global Admin</span>
              </div>
            </div>
          </div>
        </header>
